...
const cina = ["https://files.catbox.moe/b5xhbq.jpg"]
 ...
 conn.sendMessage(m.chat, { 
        ...
        contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
                newsletterName: "© N7",
                newsletterJid: `120363297155873412@newsletter`
            },
            isForwarded: true,
            externalAdReply: {
               ...
               body: `A simple WhatsApp bot uses JavaScript to respond to commands automatically.`,
                mediaType: 1,
                thumbnailUrl: `https://files.catbox.moe/jfcqy2.jpg`,
                thumbnail: ``,
                sourceUrl: `https://github.com/kiuur`
            }
        }
    }, { quoted: m });
  };
...
case 'qc': {
if (!q) return reply(`mana text nya? contoh ${prefix + command} apanih cok`)
let obj = {
type: 'quote',
format: 'png',
...
conn.sendImageAsSticker(m.chat, buffer, { packname: `${global.packname}`, author: `${global.author}`})
}
break
